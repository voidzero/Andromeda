...
void main(){
    ...
    #ifdef TRANSLATE_UV
       calcTexCoord = texCoord + m_TranslateAmount;
    #else
       calcTexCoord = texCoord;
    #endif
               ...
               newTexCoord = steepParallaxOffset(m_NormalMap, vViewDir, calcTexCoord, m_ParallaxHeight);
           #else
               //parallax map is a texture
               newTexCoord = steepParallaxOffset(m_ParallaxMap, vViewDir, calcTexCoord, m_ParallaxHeight);         
           #endif
       #else
           #ifdef NORMALMAP_PARALLAX
               //parallax map is stored in the alpha channel of the normal map         
               newTexCoord = classicParallaxOffset(m_NormalMap, vViewDir, calcTexCoord, m_ParallaxHeight);
           #else
               //parallax map is a texture
               newTexCoord = classicParallaxOffset(m_ParallaxMap, vViewDir, calcTexCoord, m_ParallaxHeight);
           #endif
       #endif
    #else
       newTexCoord = calcTexCoord;    
    #endif
